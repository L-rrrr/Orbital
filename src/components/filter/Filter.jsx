...
const Filter = () => {
  ...
  const setFilter = (filters) => {
    const { propertyType, roomType, minPrice, maxPrice, minRating, mealPlan, academicPrograms, hostelActivities, airCon } = filters;
    const filteredData = hostels.filter((hostel) => {
      ...
      return matchesPropertyType && matchesRoomType && matchesMinPrice && matchesMaxPrice && matchesMinRating && matchesMealPlan && matchesAcademicPrograms && matchesHostelActivities && matchesAirCon;
    });
  ...
  const handleApplyFilter = () => {
    ...
    const filters = { propertyType, roomType, minPrice, maxPrice, minRating, mealPlan, academicPrograms, hostelActivities, airCon };
    setFilter(filters);
  };
